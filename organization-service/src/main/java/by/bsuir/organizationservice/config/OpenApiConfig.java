...
public class OpenApiConfig {
    ...
    public OpenAPI organizationServiceAPI() {
        ...
        gatewayServer.setUrl("http://localhost:8765/organization-service");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("REST API для управления организациями, сотрудниками и инвитационными кодами в системе WMS")
                .license(license);
